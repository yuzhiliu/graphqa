...
def decoder_cell(args, layer_mul, beam_width, dynamic_batch_size, features,
    ...
    d_cell_initial = d_cell.zero_state(attn_batch_size,
            dtype).clone(cell_state=attn_encoder_state)
...
def model_fn(features, labels, mode, params):
    ...
    word_embedding = tf.get_variable("word_embedding", [args["vocab_size"],
        args["num_units"]], tf.float32)
