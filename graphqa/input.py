...
def gen_input_fn(args, mode, question=None):
    """ Generate input function based on https://github.com/tensorflow/nmt """
	vocab_hashtable = load_vocab_hashtable(args)
	consts = get_constants(args)

	# Load data source
	if question is not None:
		# Quickly pre-process for tokenization (e.g. add spaces, strip formatting)
